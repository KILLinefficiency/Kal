...
#define SET(X, Y) VarTable::set(X, Y, nullptr, VAR, false, 0, false, memory)
...
void test_var() {
    ...
    SET("name", "\"Kal\"");
    actual_string = "\"Kal\"";
    found_string = VarTable::print("name", memory);
    check(found_string, actual_string);

    SET("pi", "3.14");
    actual_value = 3.14;
    found_value = std::stod(VarTable::print("pi", memory));
    check(found_value, actual_value);

    // Tests for re-assignment of values.
    SET("age", "20");
    actual_value = 20;
    found_value = std::stod(VarTable::print("age", memory));
    check(found_value, actual_value);
    SET("age", "21");
    actual_value = 21;
    found_value = std::stod(VarTable::print("age", memory));
    ...
    found_string = VarTable::print("age", memory);
    check(found_string, actual_string);
    ...
    SET("duplicate", "value");
    actual_value = 100;
    found_value = std::stod(VarTable::print("duplicate", memory));
    check(found_value, actual_value);

    // Tests for assignment of lists.
    SET("data", "[3.14, 9.8, 2.71]");
    actual_string = "[3.14, 9.8, 2.71]";
    found_string = VarTable::print("data", memory);
    check(found_string, actual_string);

    check(std::stod(VarTable::print("data[0]", memory)), 3.14);
    check(std::stod(VarTable::print("data[1]", memory)), 9.8);
    check(std::stod(VarTable::print("data[2]", memory)), 2.71);
    ...
    actual_string = "\"g\"";
    found_string = VarTable::print("data[1]", memory);
    check(found_string, actual_string);

    // Tests for list of dynamic types.
    SET("types", "[3.14, \"PI\"]");
    actual_value = 3.14;
    found_value = std::stod(VarTable::print("types[0]", memory));
    check(found_value, actual_value);
    actual_string = "\"PI\"";
    found_string = VarTable::print("types[1]", memory);
    check(found_string, actual_string);

    // Tests for assignment of multi-dimensional lists.
    SET("nd_data", "[\n\t[0, 0], \n\t[0, 1], \n\t[1, 0], \n\t[1, 1]\n]");
    actual_string = "[[0, 0], [0, 1], [1, 0], [1, 1]]";
    found_string = VarTable::print("nd_data", memory);
    check(found_string, actual_string);
    actual_string = "[1, 0]";
    // error when nd_data was mis-spelt, fix that.
    found_string = VarTable::print("nd_data[2]", memory);
    check(found_string, actual_string);
    actual_value = 0;
    found_value = std::stod(VarTable::print("nd_data[1][0]", memory));
    check(found_value, actual_value);
    actual_value = 1;
    found_value = std::stod(VarTable::print("nd_data[1][1]", memory));
    check(found_value, actual_value);
    ...
    actual_string = "\"a\"";
    found_string = VarTable::print("a_val", memory);
    check(found_string, actual_string);
    SET("kal_list", "nd_data[3]");
    actual_string = "[\"K\", \"a\", \"l\"]";
    found_string = VarTable::print("kal_list", memory);
    check(found_string, actual_string);
    ...
    found_string = VarTable::print("second", memory);
    check(found_string, actual_string);
    ...
    found_string = VarTable::print("my_data", memory);
    check(found_string, actual_string);

    SET("bio", "#(jobs -> 9, company -> \"Kal\", positions -> [\"engineering\", \"testing\"])");
    actual_value = 9;
    // add error when wrong key (non-string) is passed.
    found_value = std::stod(VarTable::print("bio[\"jobs\"]", memory));
    check(found_value, actual_value);
    actual_string = "\"engineering\"";
    found_string = VarTable::print("bio[\"positions\"][0]", memory);
    check(found_string, actual_string);
    ...
    actual_string = "\"Kal\"";
    found_string = VarTable::print("bio_name", memory);
    check(found_string, actual_string);

    SET("bio_post", "bio[\"positions\"][1]");
    actual_string = "\"testing\"";
    found_string = VarTable::print("bio_post", memory);
    check(found_string, actual_string);
    ...
    found_string = VarTable::print("info[\"real name\"]", memory);
    check(found_string, actual_string);
    ...
    SET("ref_value", "&value");
    actual_value = 100;
    found_value = std::stod(VarTable::print("ref_value", memory));
    check(found_value, actual_value);
    ...
    SET("ref_value", "300");
    actual_value = 300;
    found_value = std::stod(VarTable::print("value", memory));
    check(found_value, actual_value);
    ...
    found_string = VarTable::print("list", memory);
    check(found_string, actual_string);

    SET("list[2]", "500");
    actual_string = "[5, 50, 500]";
    found_string = VarTable::print("ref_list", memory);
    check(found_string, actual_string);
    ...
    SET("infoB[0]", "5");
    actual_string = "[1, 3, 5]";
    found_string = VarTable::print("infoA", memory);
    check(found_string, actual_string);
    actual_string = "[5, 7, 9]";
    found_string = VarTable::print("infoB", memory);
    check(found_string, actual_string);
    ...
    found_string = VarTable::print("duplicate_matrix", memory);
    check(found_string, actual_string);
    actual_string = "[[1, 100, 3], [4, 200, 6], [7, 300, 9]]";
    found_string = VarTable::print("matrix", memory);
    check(found_string, actual_string);
    ...
    found_string = VarTable::print("full_name", memory);
    check(found_string, actual_string);
    ...
    found_string = VarTable::print("info[\"name\"]", memory);
    check(found_string, actual_string);
    VarTable::gc(0, memory);
    ...
    SET("[a, b, c]", "[1, 2, 3]");
    actual_string = "1";
    found_string = VarTable::print("a", memory);
    check(found_string, actual_string);
    actual_string = "2";
    found_string = VarTable::print("b", memory);
    check(found_string, actual_string);
    actual_string = "3";
    found_string = VarTable::print("c", memory);
    check(found_string, actual_string);

    SET("[x, y]", "[45, 55, 100]");
    actual_string = "45";
    found_string = VarTable::print("x", memory);
    check(found_string, actual_string);
    actual_string = "55";
    found_string = VarTable::print("y", memory);
    check(found_string, actual_string);

    SET("[p, _, r]", "[\"Hello\", \"There\", \"World\"]");
    actual_string = "\"Hello\"";
    found_string = VarTable::print("p", memory);
    check(found_string, actual_string);
    actual_string = "\"World\"";
    found_string = VarTable::print("r", memory);
    check(found_string, actual_string);

    SET("data", "[3.14, 9.8, 2.71]");
    SET("[_, g, e]", "data");
    actual_string = "9.8";
    found_string = VarTable::print("g", memory);
    check(found_string, actual_string);
    found_string = "2.71";
    actual_string = VarTable::print("e", memory);
    check(found_string, actual_string);
    VarTable::gc(0, memory);
    ...
    actual_string = "20";
    found_string = VarTable::print("first", memory);
    check(found_string, actual_string);
    actual_string = "10";
    found_string = VarTable::print("second", memory);
    check(found_string, actual_string);
    ...
    check(found_string, actual_string);
    actual_string = "3.14";
    found_string = VarTable::print("pi", memory);
    check(found_string, actual_string);
    VarTable::gc(0, memory);
    ...
    check(found_string, actual_string);
    actual_string = "30";
    found_string = VarTable::print("q", memory);
    check(found_string, actual_string);
    actual_string = "[2, 2, 5]";
    found_string = VarTable::print("p", memory);
    check(found_string, actual_string);
    ...
    actual_string = "100";
    found_string = VarTable::print("new_info", memory);
    check(found_string, actual_string);
    found_string = VarTable::print("new_data", memory);
    check(found_string, actual_string);

    SET("new_data", "new_info_a := (45 + 55)");
    actual_string = "100";
    found_string = VarTable::print("new_info_a", memory);
    check(found_string, actual_string);
    found_string = VarTable::print("new_data", memory);
    check(found_string, actual_string);
    ...
    actual_string = "100";
    found_string = VarTable::print("new_info_b", memory);
    check(found_string, actual_string);
    actual_string = "200";
    found_string = VarTable::print("new_data", memory);
    check(found_string, actual_string);
    ...
    SET("abc", "pqr := &xyz");
    actual_string = "50";
    found_string = VarTable::print("pqr", memory);
    check(found_string, actual_string);
    found_string = VarTable::print("abc", memory);
    check(found_string, actual_string);
    ...
    line_exec(tokens, false, false, false, memory);
    found_string = VarTable::print("value", memory);
    actual_string = "10";
    check(found_string, actual_string);
    found_ptr = VarTable::get("info", {}, true, true, true, memory);
    actual_ptr = nullptr;
    ...
    actual_string = "20",
    check(found_string, actual_string);
    found_ptr = VarTable::get("data", {}, true, true, true, memory);
    actual_ptr = nullptr;
    check(found_ptr, actual_ptr);
    ...
    tokens = lexer::tokenize(lines);
    line_exec(tokens, false, false, false, memory);
    found_string = VarTable::print("temp", memory);
    actual_string = "100";
    check(found_string, actual_string);
    found_string = VarTable::print("value", memory);
    actual_string = "60";
